function [Y_hat_k_opt, B_k_opt, k_opt_universal, k_opt_list_sample, sample_indices] = ridge_regression_analysis(image_file_path, regressor_matrix, k_values, default_mask_applied, mask_file_path, k_opt_only, num_cores)
